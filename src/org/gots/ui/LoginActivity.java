...
public class LoginActivity extends SherlockActivity {
	...
	protected void onResume() {
		...
		connect.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				String token = request_token(false);
				if (token == null) {
	...
	public String request_token(boolean revoke) {
			...
			protected String doInBackground(Object... objects) {
				try {
					...
					urlConnection.addRequestProperty(
							"Authorization",
							"Basic "
									+ Base64.encodeToString((loginText.getText().toString() + ":" + passwordText.getText()
...
//							"Authorization",
//							"Basic "
//									+ Base64.encodeBase64((loginText.getText().toString() + ":" + passwordText.getText()
//											.toString()).getBytes()));
