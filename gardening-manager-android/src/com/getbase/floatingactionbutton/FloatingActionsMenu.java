        ...
        case EXPAND_DOWN:
            ...
            for (int i = mButtonsCount - 1; i >= 0; i--) {
                ...
                if (label != null) {
                    ...
                    Rect touchArea = new Rect(Math.min(childX, labelLeft), childY - mButtonSpacing / 2, Math.max(childX
                            + child.getMeasuredWidth(), labelRight), childY + child.getMeasuredHeight()
                            + mButtonSpacing / 2);
